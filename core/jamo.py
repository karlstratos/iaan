# Author: Joshua Dong (jdong42@gmail.com)
# Modifier: Karl Stratos (me@karlstratos.com)
# The original code is from here: https://github.com/JDongian/python-jamo.
# It is ported from Python 3 to Python 2.
"""
...
with open(os.path.join(_ROOT, "jamo-json", "U+11xx.json"), 'r') as namedata:
    _JAMO_TO_NAME = json.load(namedata)
_JAMO_REVERSE_LOOKUP = {name: char for char, name in _JAMO_TO_NAME.items()}
with open(os.path.join(_ROOT, "jamo-json", "U+31xx.json"), 'r') as namedata:
